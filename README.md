...
test suites (26 core tests + 6 web tests + 116 ingestion tests). Safe to re-run.
...
python3 -m venv .venv && . .venv/bin/activate
pip install -e ".[dev]"
pytest -v                                    # 116 tests, all mocked -- no network needed
