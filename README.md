...
test suites (54 core tests + 6 web tests + 354 ingestion tests). Safe to re-run.
...
python3 -m venv .venv && . .venv/bin/activate
pip install -e ".[dev]"
pytest -v                                    # 354 tests, all mocked -- no network needed
